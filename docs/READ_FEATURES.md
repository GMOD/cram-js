...
You can get at the list directly, as `record.readFeatures`. Most code has no
reason to, and this page is mostly here to talk you out of it. If you do need
it, everything you have to know is below.
